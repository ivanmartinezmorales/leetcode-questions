public class MaxSubArray {
    ...
    public static void main(String[] args) {
      ...
      if (solution == 6) {
        System.out.println("You did it, it's right!");
      }
    ...
    public int maxSubArray(int[] nums) {
        ...
        // of the local maximum element, and then we need the value of the global maximum that
        // we've **seen so far**.
        
        // So first:
        // we have two integers, one to keep track of the current sum, and one to keep track of the maximum sum
        ...
        // Now lets iterate over the entire list, omitting the first element since we've already accounted for it
        ...
        // when we're done iterating through the entire list, we've found our biggest number in maxSum
